...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, \
                 shuffle=True, resolution_scales=[1.0],random_init=False,shuffle_data=False,cf_nerf_name=None):
        """b
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval,random_init_pcd=random_init,shuffle_data=shuffle_data,cf_nerf_name=cf_nerf_name)
